...
<div class="col-md-6">
    <div class="card mt-3">
        <div class="card-header text-muted" style="border-bottom:none">
            <h3 class="text-primary mb-0">Ils suivent <a href="/profile/<?= $user->pseudo ?>" class="link-underline link-underline-opacity-0">@<?= $user->pseudo ?></a></h3>
        </div>
    </div>

    <div class="card mt-3">
        <?php foreach ($follower_user_data as $i => $follower) : ?>
